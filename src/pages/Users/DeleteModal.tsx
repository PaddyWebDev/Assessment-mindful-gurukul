...
export default function DeleteModal({ Id, ReturnBack }: any) {
    async function DeleteUser() {
        ReturnBack(Id)
    }
    return (
        <>
            <button data-modal-target="delete-modal" data-modal-toggle="delete-modal" className="text-red-700 hover:hover:bg-red-800 focus:hover:bg-red-800 dark:hover:bg-red-700 dark:focus:bg-red-700 dark:text-red-600 hover:text-[#fafafa] focus:text-[#fafafa] p-2 rounded-full" type="button">
                <Trash2 />
            </button>
                ...
                <div className="relative w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <button onClick={DeleteUser} data-modal-hide="delete-modal" type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                Yes, {"I'm"} sure
                            </button>
